Public Class DataGridViewDateTimeColumn
    Inherits DataGridViewColumn

    Public Sub New()
        MyBase.New(New DataGridViewDateTimeCell())
    End Sub
    ...
    Public Overrides Property CellTemplate() As DataGridViewCell
        ...
        Set(ByVal value As DataGridViewCell)
            ...
            If Not (value Is Nothing) AndAlso
                Not value.GetType().IsAssignableFrom(GetType(DataGridViewDateTimeCell)) _
                Then
...
Public Class DataGridViewDateTimeCell
    ...
    Public Overrides Sub InitializeEditingControl(ByVal rowIndex As Integer,
        ...
        Dim ctl As CalendarDateTimeEditingControl =
            CType(DataGridView.EditingControl, CalendarDateTimeEditingControl)
    ...
    Public Overrides ReadOnly Property EditType() As Type
        Get
            ...
            Return GetType(CalendarDateTimeEditingControl)
        End Get
    End Property
...
Class CalendarDateTimeEditingControl
