...
Public Class DataGridViewTimeCell
    ...
    Public Overrides Sub InitializeEditingControl(ByVal rowIndex As Integer,
        ...
        Dim ctl As CalendarTimeEditingControl =
            CType(DataGridView.EditingControl, CalendarTimeEditingControl)
    ...
    Public Overrides ReadOnly Property EditType() As Type
        Get
            ...
            Return GetType(CalendarTimeEditingControl)
        End Get
    End Property
...
Class CalendarTimeEditingControl
